  ...
  return (
    <>
      ...
      <View className='flex p-6 w-full h-full justify-center items-center'>
        <TextInput className="border-black border-2 pl-1.5 pr-1.5 size-auto font-black text-3xl rounded-2xl bg-blue-400" style={styles.input} onChangeText={handleInputChange} value={text} placeholder="Enter the name of a song"/>
